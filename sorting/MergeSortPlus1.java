...
public class MergeSortPlus1 {
	...
	private void insertionSort(int[] tempStorage, int l, int r) {
		{
			for (int i = l; i <= r; i++) {
				int tmp = tempStorage[i];
				int j = i;
				while ((j >= 1) && (tempStorage[j - 1] > tmp)) {
	...
	public static void main(String[] args) {
		MergeSortPlus1 ms = new MergeSortPlus1();
		// ms.testMerge();
		ms.testMergeSort();
	}
